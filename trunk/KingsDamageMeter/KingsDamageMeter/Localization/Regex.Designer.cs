...
namespace KingsDamageMeter.Localization {
    ...
    internal class Regex {
        ...
        /// <summary>
        ///   Looks up a localized string similar to (?&lt;name&gt;.+) received (?&lt;damage&gt;[^a-zA-Z]+) (bleeding|poisoning) damage after you used (?&lt;skill&gt;.+)\..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to You caused (?&lt;target&gt;.+) to bleed by using (?&lt;skill&gt;.+)\..
        /// </summary>
